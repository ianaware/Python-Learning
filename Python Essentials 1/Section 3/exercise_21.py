...
band_input = input("Do you want to add Stu Sutcliffe and Pete Best to the band? ")
if band_input == 'Y' or band_input == 'y':
    for member in ["Stu Sutcliffe", "Pete Best"]:
        beatles.append(member)
    print(beatles)
    band_input = input("Do you want to remove Stu Sutcliffe from the band? ")
    if band_input == 'Y' or band_input == 'y':
       del beatles[beatles.index("Stu Sutcliffe")]
    band_input = input("Do you want to remove Pete Best from the band? ")
    if band_input == 'Y' or band_input == 'y':
         del beatles[beatles.index("Pete Best")]
    band_input = input("Do you want to add Ringo Starr to the band? ")
    if band_input == 'Y' or band_input == 'y':
